...
import { guns } from "../types/loadout";
...
function createSkinsFiles(skinsData, startingFileData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fs.writeFile(`${root}/src/types/skins.ts`, unionType);
        yield fs.writeFile(`${root}/src/types/chroma.ts`, chroma + "null;");
        yield fs.writeFile(`${root}/src/resources/skins.ts`, [
            startingFileData,
...
function createAgentsFiles(agentsData, startingFileData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fs.writeFile(`${root}/src/types/agents.ts`, [startingFileData, agentsUnionType]);
        yield fs.writeFile(`${root}/src/resources/agents.ts`, [
            startingFileData,
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data: { data: skins }, } = yield axios.get("https://valorant-api.com/v1/weapons/skins");
    const { data: { data: buddies }, } = yield axios.get("https://valorant-api.com/v1/buddies");
    const { data: { data: sprays }, } = yield axios.get("https://valorant-api.com/v1/sprays");
    const { data: { data: agents }, } = yield axios.get("https://valorant-api.com/v1/agents?isPlayableCharacter=true");
