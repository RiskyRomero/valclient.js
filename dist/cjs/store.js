...
class Store {
    ...
    wallet() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const walletMapped = balanceIds.reduce((initialValue, balanceId) => (Object.assign(Object.assign({}, initialValue), { [_resources_1.walletMappedByID[balanceId]]: Balances[balanceId] })), {});
            return walletMapped;
        });
    }
    /**
    ...
    yourItems(item_type) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = _resources_1.itemsMappedByName[item_type];
